<template>
  <div v-for="(param, index) in dynamicInput.params" :key="index" style="display: flex">
    <a-textarea placeholder="请输入选项" v-model:value="param.label" style="width: 50%; margin-bottom: 5px" @input="emitChange" />
    <a-input placeholder="请输入选项权重" v-model:value="param.value" style="width: 15%; margin: 0 0 5px 5px" @input="emitChange" />
    <MinusCircleOutlined
