<template>
  <div>
   ...
   <BasicTable @register="registerTable" :rowSelection="rowSelection">
    ...
    <!-- 表单区域 -->
    <NlQuestionnaireListModal @register="registerModal" @success="handleSuccess"></NlQuestionnaireListModal>
  </div>
</template>
...
<script lang="ts" name="nl_questionnaire_list-nlQuestionnaireList" setup>
  ...
  import {list, deleteOne, batchDelete, getImportUrl,getExportUrl} from './NlQuestionnaireList.api';
