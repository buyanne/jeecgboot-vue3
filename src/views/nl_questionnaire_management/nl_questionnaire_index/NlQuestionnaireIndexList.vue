<template>
  <div>
   ...
   <BasicTable @register="registerTable" :rowSelection="rowSelection">
    ...
    <!-- 表单区域 -->
    <NlQuestionnaireIndexModal @register="registerModal" @success="handleSuccess"></NlQuestionnaireIndexModal>
  </div>
</template>
...
<script lang="ts" name="nl_questionnaire_index-nlQuestionnaireIndex" setup>
  ...
  import {list, deleteOne, batchDelete, getImportUrl,getExportUrl} from './NlQuestionnaireIndex.api';
