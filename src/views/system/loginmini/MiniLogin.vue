...
<!--                  <div class="aui-flex">-->
<!--                    <a class="aui-linek-code aui-flex-box"-->
<!--                       @click="codeHandleClick">{{ t('sys.login.qrSignInFormTitle') }}</a>-->
<!--                  </div>-->
                  <div class="aui-flex">
                    <a class="aui-linek-code aui-flex-box"
                       @click="registerHandleClick">{{ t('sys.login.registerButton') }}</a>
                  </div>
                </div>
              </div>
...
<!--                      <a title="github" @click="onThirdLogin('github')">-->
<!--                        <GithubFilled/>-->
<!--                      </a>-->
<!--                    </div>-->
<!--                  </div>-->
...
<!--                  <div class="aui-flex-box">-->
<!--                    <div class="aui-third-login">-->
<!--                      <a title="钉钉" @click="onThirdLogin('dingtalk')">-->
