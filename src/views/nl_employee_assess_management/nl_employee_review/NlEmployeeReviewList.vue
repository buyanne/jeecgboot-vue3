<template>
  <div>
    <!--引用表格-->
    <BasicTable v-if="!unref(isFormShow)" @register="registerTable" :rowSelection="rowSelection">
      <!--插槽:table标题-->
      <template #tableTitle>
    ...
    <a-button v-if="unref(isFormShow)" @click="handleBack">返回</a-button>
    <ReviewInfoForm :infoId="infoId" v-if="unref(isFormShow)"></ReviewInfoForm>
    <!-- 表单区域 -->
...
import ReviewInfoForm from "./components/ReviewInfoForm.vue";
