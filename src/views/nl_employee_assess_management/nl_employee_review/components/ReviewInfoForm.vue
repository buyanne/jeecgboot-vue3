...
import {
  getBpmFormSchema1
} from "/src/views/nl_employee_assess_management/nl_employee_info/NlEmployeeInfo.data";
import {
saveOrUpdate} from "../NlEmployeeReview.api";
...
export default defineComponent({
  ...
  setup: function(props) {
    ...
    async function initFormData() {
      ...
      const sysUser = await defHttp.get({ url: queryByIdUrl,params });
