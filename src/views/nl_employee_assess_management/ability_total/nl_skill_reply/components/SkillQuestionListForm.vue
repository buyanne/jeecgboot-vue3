...
export default defineComponent({
  ...
  setup: function(props) {
    ...
    const queryQuestionnaire = "/nl_skill_reply/nlEmployeeSkillRequestReply/queryQuestionnaire";
    const queryQuestionList = "/nl_skill_reply/nlEmployeeSkillRequestReply/queryQuestionList";
    const saveReply = "/nl_skill_reply/nlEmployeeSkillRequestReply/saveReply";
