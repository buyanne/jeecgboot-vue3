...
enum Api {
  list = '/nl_assess_plan/nlEmployeeAssessPlan/list',
  save = '/nl_assess_plan/nlEmployeeAssessPlan/add',
  edit = '/nl_assess_plan/nlEmployeeAssessPlan/edit',
  deleteOne = '/nl_assess_plan/nlEmployeeAssessPlan/delete',
