<template>
  <div>
    ...
    <!-- 表单区域 -->
    <NlEmployeeAssessPlanModal @register="registerModal" @success="handleSuccess" />
  </div>
</template>

<script lang="ts" name="nl_assess_plan-nlEmployeeAssessPlan" setup>
  import { ref, reactive, computed, unref } from 'vue';
  import { BasicTable, useTable, TableAction } from '/@/components/Table';
  import { useModal } from '/@/components/Modal';
  import { useListPage } from '/@/hooks/system/useListPage';
  import NlEmployeeAssessPlanModal from './components/NlEmployeeAssessPlanModal.vue';
  import { columns, searchFormSchema, superQuerySchema } from './NlEmployeeAssessPlan.data';
